# Android Huawei destination SDK for IBM Cloud Event Notifications service Version 1.2.0
...
--- | ---
[Event Notifications Service](https://cloud.ibm.com/apidocs/event-notifications) | com.ibm.cloud:eventnotifications-huawei-android:1.2.0
...
### Gradle
```gradle
compile 'com.ibm.cloud:eventnotifications-huawei-android:1.2.0'
```
...
2. Add SDK dependency to your Module level `build.gradle` file.
   ...
   dependencies {
       ...
       implementation 'com.ibm.cloud:eventnotifications-huawei-android:1.2.0'
       .......
   }
   ```
